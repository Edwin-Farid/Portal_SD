...
<head>
  ...
  <title>Login Administrator</title>
    ...
    <link rel="icon" href="<?= base_url() ?>assets/web/assets/img/logo/logo1.png">
        <meta name="description" content="Mts Nwdi Pancor Lombok Timur">
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="<?= base_url() ?>assets/web/assets/img/logo/logo1.png" rel="icon">
  <link href="<?= base_url() ?>assets/web/assets/img/logo/logo1.png" rel="apple-touch-icon">
